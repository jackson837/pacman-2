...
let drawGameOver = () => {
    ...
    canvasContext.fillText("press R to restart ", canvas.width / 1.97, canvas.height / 1.7);
    canvasContext.font = "35px san serif";
    canvasContext.fillText("press M for music", canvas.width / 1.97, canvas.height / 1.5);
};
